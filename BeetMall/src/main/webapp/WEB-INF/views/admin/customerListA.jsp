...
<div id="body1">
	<div id="container">
		<div id="topBar">
			<ul>
				<li><h5><strong><a href="customerListA">회원관리</a></strong></h5></li> 
		...
		<div id="choose">
			<a href="customerListA"><button class="success" value="" name="" id="" style="background-color:lightgray;">일반회원</button></a>
			<a href="sellerListA"><button class="success" value="" name="" id="">판매자회원</button></a>
		</div> 
		<div id="sortBox">
			<ul>
				<li><select name="sort" > 
