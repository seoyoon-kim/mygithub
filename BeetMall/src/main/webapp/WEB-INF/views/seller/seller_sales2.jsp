...
function excelPaging(num , excelPagingInit){
	...
	console.log(MathNum);
	console.log('excel넘버 확인 ====>'+excelPagingInit);
...
// 엑셀저장
$('#excelDown').click( () => {
	console.log(excelArrList[0]);
	console.log(excelArrList.length);
	let excelData = [];
	for(let i =0; i<excelArrList.length; i++){
		excelData.push(excelArrList[i].productnum);
